...
Both of these limitations could be overcome through clever workings of the assembler or ISA, however, there was not enough time to implement those features.
